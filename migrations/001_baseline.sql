-- 001_baseline: ARCH-001 domain & sync foundation schema.
-- Authoritative source of truth lives in src/persistence/sqlite/migrations.ts;
-- this file is a review/integration copy for Cursor and NAS work.
